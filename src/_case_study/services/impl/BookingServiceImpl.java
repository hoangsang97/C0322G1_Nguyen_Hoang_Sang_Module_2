    ...
    public static Facility chooseFacility() {
        ...
        for (Map.Entry<Facility, Integer> entry : facilityMap.entrySet()) {
            ...
            if (entry.getKey() instanceof Villa) {
                villaMap.put((Villa) entry.getKey(), entry.getValue());
            }
        }
            ...
            for (Map.Entry<Facility, Integer> entry : facilityMap.entrySet()) {
                if (id.equals(entry.getKey().getIdFacility())) {
                    ...
                    for (Map.Entry<Villa, Integer> item : villaMap.entrySet()) {
                        stringList.add(item.getKey().getIdFacility() + "," + item.getKey().getNameService() + "," + item.getKey().getAreaUse() + "," + item.getKey().getRentalPrice() + "," + item.getKey().getRentalPeopleMax() + "," + item.getKey().getStyleRental() + "," + item.getKey().getStandardVilla() + "," + item.getKey().getAreaPool() + "," + item.getKey().getFloor() + "," + entry.getValue());
                    }
