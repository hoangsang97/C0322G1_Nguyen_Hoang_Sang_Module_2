package exercise.structure_product.service;

import exercise.structure_product.model.Product;
...
public class ProductService implements IProductService {
    ...
    static {
        ...
        productList.add(new Product(3, "iphone 12", 200, 10, "America"));
        productList.add(new Product(4, "iphone 13", 200, 10, "America"));
        productList.add(new Product(5, "iphone 14", 200, 10, "America"));
    }
